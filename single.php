...
<section class="container-box mt-80">
		...
		<div class="row">
			...
			<div class="col-md-4 col-12">
				<div class="subscribe">
					<h5 class="mb-10">Join 3500 of your HR peers and stay relevant on latest trends</h5>
					...
					<form id="email-subscribe">
						<div class="input-group input-group-lg">
							...
							<button class="btn btn-primary btn-input btn-input-sm" type="button" id="button-addon2">Subscribe</button>
						</div>
					</form>
				</div>
				<div class="p-30 border-slate-40 rounded">
