        ...
        <div class="container">
            <div class="row mx-0 py-50">
                ...
                <div class="col-md-8 d-none d-md-block mb-xs-40">
                    <div class="row mx-0">
                        <div class="col-lg-9 col-md-12 mx-0">
                            <div class="row mx-0">
                                <div class="col-md-6 mb-5">
                                    <h5 class="text-white font-18 mb-8">Data Analytics</h5>
                                    <ul class="list-group">
                                ...
                                <div class="col-md-6 mb-5">
                                    <h5 class="text-white font-18 mb-8">Cloud Transformation</h5>
                                    <ul class="list-group">
                                        <li class="list-group-item bg-transparent p-0 border-0 font-14 footer-text-color">
                                            Cloud Migration
                                        </li>
        ...
        <div class="container">
            <div class="row align-items-center mx-0 py-40">
                <div class="col-md-5 col-sm-7 col-12  mb-xs-20">
                    <div>
                        <span class="copyright-color font-16">© 2020, Technovert Solutions Inc</span>
                    </div>
                </div>
